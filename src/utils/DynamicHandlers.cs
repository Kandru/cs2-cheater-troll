...
namespace CheaterTroll.Utils
{
    ...
    {
        public static void RegisterModuleListener(BasePlugin basePlugin, string listenerName, PluginBlueprint plugin)
        {
        ...
        public static void DeregisterModuleListener(BasePlugin basePlugin, string listenerName, PluginBlueprint plugin)
        {
            // get the listener type from CounterStrikeSharp.API.Core.Listeners
            Type? listenerType = typeof(Listeners).GetNestedType(listenerName);
            if (listenerType == null)
        ...
        public static void RegisterModuleEventHandler(BasePlugin basePlugin, string eventName, PluginBlueprint plugin)
        {
        ...
        public static void DeregisterModuleEventHandler(BasePlugin basePlugin, string eventName, PluginBlueprint module)
        {
            // get the event type from CounterStrikeSharp.API.Core
            Type? eventType = typeof(BasePlugin).Assembly.GetType($"CounterStrikeSharp.API.Core.{eventName}");
            if (eventType == null)
        ...
        public static void RegisterUserMessageHook(BasePlugin basePlugin, int messageId, PluginBlueprint plugin, HookMode hookMode)
        {
            // get the method from the module
        ...
        public static void DeregisterUserMessageHook(BasePlugin basePlugin, int messageId, PluginBlueprint plugin, HookMode hookMode)
        {
            // get the method from the module
            MethodInfo? method = plugin.GetType().GetMethod($"HookUserMessage{messageId}");
            if (method == null)
